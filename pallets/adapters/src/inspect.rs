...
use frame_support2::traits::fungible::Inspect as FungibleInspect;
use frame_support2::traits::fungibles::Inspect as FungiblesInspect;
use frame_support2::traits::tokens::{DepositConsequence, WithdrawConsequence};
