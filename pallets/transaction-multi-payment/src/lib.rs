...
use hydradx_traits2::pools::SpotPriceProvider;
...
use hydradx_traits2::{NativePriceOracle};
...
pub mod pallet {
    ...
    use crate::AssetIdOf;
    use crate::WeightToFee;
    use sp_runtime::traits::Zero;
use orml_traits::MultiCurrency;
    use crate::MultiCurrencyExtended;
    use crate::BalanceOf;
    use crate::FixedPointOperand;
    use crate::SpotPriceProvider;
    use crate::Price;
...
where
    ...
    DF: DepositFee<T::AccountId, MC::CurrencyId, MC::Balance>,<MC as orml_traits::MultiCurrency<<T as frame_system::Config>::AccountId>>::Balance: sp_arithmetic::rational::MultiplyRational
{
